...
def render_anim_component(kind: str, label: str) -> None:
        ...
        "team": """
          <div class="team-board">
            <div class="member-card liao">
              <div class="avatar long-hair"><div class="hair"></div><div class="bangs"></div><div class="face"></div><div class="neck"></div><div class="shirt"></div></div>
              <strong>廖怡絜</strong><span>成本、損益、定價</span>
            </div>
            <div class="member-card tseng">
              <div class="avatar short-hair"><div class="hair"></div><div class="bangs"></div><div class="face"></div><div class="neck"></div><div class="shirt"></div></div>
              <strong>曾楷芸</strong><span>市場、通路、訪談</span>
            </div>
            <div class="member-card chiou">
              <div class="avatar ombre-hair"><div class="hair"></div><div class="gold-layer"></div><div class="bangs"></div><div class="face"></div><div class="neck"></div><div class="shirt"></div></div>
    ...
    <style>
      ...
      .judge-table{position:absolute;left:8%;top:72px;width:430px;display:grid;gap:10px}.judge-row{height:52px;border-radius:8px;background:white;border:1px solid #d9dfd6;display:flex;align-items:center;gap:14px;padding:0 16px;box-shadow:0 12px 24px rgba(23,33,29,.1);animation:float 3.2s infinite}.judge-row:nth-child(2){animation-delay:.25s}.judge-row:nth-child(3){animation-delay:.5s}.judge-row:nth-child(4){animation-delay:.75s}.judge-row strong{min-width:72px;color:#c7653f}.judge-row span{font-weight:850;color:#17211d}.judge-score{position:absolute;right:8%;top:72px;width:280px;height:236px}.score-axis{position:absolute;background:#d9dfd6}.score-axis.x{left:20px;right:20px;top:50%;height:4px}.score-axis.y{top:20px;bottom:20px;left:50%;width:4px}.score-card{position:absolute;width:82px;height:54px;border-radius:8px;background:#17211d;color:white;display:grid;place-items:center;font-weight:900;box-shadow:0 14px 30px rgba(23,33,29,.16)}.score-card.p{left:99px;top:0}.score-card.s{right:0;top:91px;background:#496b58}.score-card.b{left:99px;bottom:0;background:#c7653f}.score-card.e{left:0;top:91px;background:#f0b45c;color:#17211d}.score-core{position:absolute;left:50%;top:50%;transform:translate(-50%,-50%);width:92px;height:92px;border-radius:50%;background:white;border:8px solid #78a083;display:grid;place-items:center;text-align:center;font-weight:900;line-height:1.2;animation:pulse 2.6s infinite}
      .team-board{position:absolute;left:7%;right:7%;top:78px;display:grid;grid-template-columns:repeat(3,1fr);gap:18px}.member-card{height:188px;border-radius:8px;background:white;border:1px solid #d9dfd6;display:grid;place-items:center;text-align:center;align-content:center;gap:4px;box-shadow:0 16px 34px rgba(23,33,29,.12);animation:float 3.4s infinite}.member-card strong{font-size:22px;line-height:1.1}.member-card span{color:#c7653f;font-weight:900;font-size:15px}.tseng{animation-delay:.35s}.chiou{animation-delay:.7s}.avatar{position:relative;width:86px;height:96px;margin-bottom:5px;animation:avatarNod 3.6s ease-in-out infinite}.avatar .face{position:absolute;left:22px;top:26px;width:42px;height:50px;border-radius:46% 46% 48% 48%;background:#f2c7a7;z-index:3;box-shadow:inset 0 -7px rgba(199,101,63,.08)}.avatar .face:before,.avatar .face:after{content:"";position:absolute;top:23px;width:4px;height:4px;border-radius:50%;background:#17211d}.avatar .face:before{left:12px}.avatar .face:after{right:12px}.avatar .neck{position:absolute;left:35px;top:70px;width:16px;height:15px;border-radius:0 0 8px 8px;background:#e9b894;z-index:2}.avatar .shirt{position:absolute;left:15px;right:15px;bottom:0;height:28px;border-radius:22px 22px 8px 8px;background:#496b58;z-index:1}.avatar .bangs{position:absolute;left:22px;top:18px;width:42px;height:22px;border-radius:24px 24px 12px 12px;background:#101713;z-index:5}.long-hair .hair{position:absolute;left:11px;top:10px;width:64px;height:82px;border-radius:32px 32px 24px 24px;background:#101713;z-index:1}.long-hair .hair:before,.long-hair .hair:after{content:"";position:absolute;top:30px;width:18px;height:58px;border-radius:999px;background:#101713}.long-hair .hair:before{left:-3px}.long-hair .hair:after{right:-3px}.short-hair .hair{position:absolute;left:15px;top:11px;width:56px;height:58px;border-radius:30px 30px 22px 22px;background:#101713;z-index:1}.short-hair .hair:before,.short-hair .hair:after{content:"";position:absolute;top:28px;width:16px;height:26px;border-radius:999px;background:#101713}.short-hair .hair:before{left:-1px}.short-hair .hair:after{right:-1px}.ombre-hair .hair{position:absolute;left:13px;top:10px;width:60px;height:74px;border-radius:32px 32px 24px 24px;background:#101713;z-index:1}.ombre-hair .gold-layer{position:absolute;left:14px;top:52px;width:58px;height:38px;border-radius:0 0 26px 26px;background:#d9a441;z-index:2}.ombre-hair .hair:before,.ombre-hair .hair:after{content:"";position:absolute;top:36px;width:17px;height:48px;border-radius:999px;background:linear-gradient(#101713 0 48%,#d9a441 48%)}.ombre-hair .hair:before{left:-3px}.ombre-hair .hair:after{right:-3px}.ombre-hair .bangs{background:#101713}.team-output{position:absolute;left:18%;right:18%;bottom:44px;height:56px;border-radius:8px;background:#17211d;color:white;display:grid;place-items:center;text-align:center;font-weight:900;font-size:18px;box-shadow:0 18px 38px rgba(23,33,29,.18)}.team-line{position:absolute;height:5px;border-radius:999px;background:#f0b45c;transform-origin:center}.team-line.l1{left:22%;top:265px;width:170px;transform:rotate(16deg)}.team-line.l2{left:44%;top:265px;width:170px}.team-line.l3{right:22%;top:265px;width:170px;transform:rotate(-16deg)}
