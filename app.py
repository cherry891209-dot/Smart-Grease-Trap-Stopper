...
def render_anim_component(kind: str, label: str) -> None:
    ...
    <style>
      ...
      .team-board{position:absolute;left:7%;right:7%;top:74px;display:grid;grid-template-columns:repeat(3,1fr);gap:18px}.member-card{height:202px;border-radius:8px;background:white;border:1px solid #d9dfd6;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;gap:5px;padding:12px;box-shadow:0 16px 34px rgba(23,33,29,.12);animation:float 3.4s infinite}.member-card strong{font-size:22px;line-height:1.15;margin-top:2px}.member-card span{color:#c7653f;font-weight:900;font-size:15px;line-height:1.25}.tseng{animation-delay:.35s}.chiou{animation-delay:.7s}.portrait{width:112px;height:116px;border-radius:8px;background-image:url("data:image/png;base64,__TEAM_IMAGE__");background-size:315px 168px;background-repeat:no-repeat;background-color:#f7f4ec;border:1px solid #d9dfd6;box-shadow:0 12px 24px rgba(23,33,29,.12);animation:portraitFloat 3.6s ease-in-out infinite}.liao-photo{background-position:3% 38%}.tseng-photo{background-position:50% 38%;animation-delay:.3s}.chiou-photo{background-position:97% 38%;animation-delay:.6s}.team-output{position:absolute;left:18%;right:18%;bottom:34px;height:56px;border-radius:8px;background:#17211d;color:white;display:grid;place-items:center;text-align:center;font-weight:900;font-size:18px;box-shadow:0 18px 38px rgba(23,33,29,.18)}.team-line{position:absolute;height:5px;border-radius:999px;background:#f0b45c;transform-origin:center}.team-line.l1{left:22%;top:276px;width:170px;transform:rotate(14deg)}.team-line.l2{left:44%;top:276px;width:170px}.team-line.l3{right:22%;top:276px;width:170px;transform:rotate(-14deg)}
