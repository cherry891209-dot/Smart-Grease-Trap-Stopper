...
def render_anim_component(kind: str, label: str) -> None:
    ...
    scenes = {
        ...
        "team": """
          <div class="team-board">
            <div class="member-card liao"><strong>廖怡絜</strong><span>成本、損益、定價</span></div>
            <div class="member-card tseng"><strong>曾楷芸</strong><span>市場、通路、訪談</span></div>
            <div class="member-card chiou"><strong>邱芷凡</strong><span>產品、規格、試點</span></div>
          </div>
    ...
    <style>
      ...
      .team-board{position:absolute;left:7%;right:7%;top:92px;display:grid;grid-template-columns:repeat(3,1fr);gap:18px}.member-card{height:142px;border-radius:8px;background:white;border:1px solid #d9dfd6;display:grid;place-items:center;text-align:center;box-shadow:0 16px 34px rgba(23,33,29,.12);animation:float 3.4s infinite}.member-card strong{font-size:25px}.member-card span{color:#c7653f;font-weight:900;font-size:17px}.tseng{animation-delay:.35s}.chiou{animation-delay:.7s}.team-output{position:absolute;left:18%;right:18%;bottom:62px;height:58px;border-radius:8px;background:#17211d;color:white;display:grid;place-items:center;text-align:center;font-weight:900;font-size:20px;box-shadow:0 18px 38px rgba(23,33,29,.18)}.team-line{position:absolute;height:5px;border-radius:999px;background:#f0b45c;transform-origin:center}.team-line.l1{left:22%;top:238px;width:170px;transform:rotate(20deg)}.team-line.l2{left:44%;top:238px;width:170px}.team-line.l3{right:22%;top:238px;width:170px;transform:rotate(-20deg)}
